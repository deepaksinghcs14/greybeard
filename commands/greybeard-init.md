---
name: greybeard-init
description: Register a root folder with greybeard and set up the local Postgres + Apache AGE graph store. Run once, or again if you want to add a new root. Scans for every git repo under the given path — you don't list repos individually.
---
