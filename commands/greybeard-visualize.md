...
description: Open the interactive cross-repo graph in the browser — force-directed layout, zoom/pan, click a node for its endpoints, schemas, symbols, and connections. Read-only view of the live graph.
---
